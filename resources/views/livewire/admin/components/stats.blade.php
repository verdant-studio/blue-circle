<div class="grid gap-4 md:gap-8 md:grid-cols-2">
    <div class="p-6 bg-white rounded-md shadow-md">
        ...
        <ul class="text-indigo-900">
            ...
            <li class="flex justify-between px-2 py-1 text-sm border-b border-indigo-100 even:bg-indigo-50">
    ...
    <div class="p-6 bg-white rounded-md shadow-md">
        ...
        <div class="text-6xl font-semibold text-indigo-900">{{ $statistics['total_visits'] }}</div>
    </div>
</div>
