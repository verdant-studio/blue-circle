<div>
    ...
    <div class="mb-8 border-b border-secondary-400">
        <ul class="flex flex-wrap -mb-px" role="tablist">
            ...
            <li class="mr-2" role="presentation">
                <a href="#settings" class="inline-flex items-center py-4 px-4 text-sm font-bold uppercase tracking-wider text-center rounded-t-lg border-b-2 hover:text-secondary-700 hover:border-secondary-900 group {{ $selectedTab === "settings" ? 'bg-white text-black border-secondary-800' : 'bg-secondary-400 text-secondary-900 border-transparent' }}" data-toggle="tab" wire:click="selectTab('settings')" aria-expanded="false">
    ...
    <div>
        ...
        <div aria-labelledby="settings-tab" class="{{ $selectedTab === "settings" ? 'block' : 'hidden' }}" role="tabpanel">
            Settings
            {{-- @include('admin.site.form-site-settings', ['site' => $site]) --}}
        </div>
    </div>
